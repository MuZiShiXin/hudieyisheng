//
//  HospitalizedPatientsTableViewCell.m
//  butterflyDoctor
//
...
@interface HospitalizedPatientsTableViewCell ()
...
@end
@implementation HospitalizedPatientsTableViewCell

+ (instancetype)cellWithTableView:(UITableView *)tableView
{
    static NSString *ID = @"HospitalizedPatientsTableViewCell";
    HospitalizedPatientsTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
        // 从xib中加载cell
        cell = [[[NSBundle mainBundle] loadNibNamed:@"HospitalizedPatientsTableViewCell" owner:nil options:nil] lastObject];
