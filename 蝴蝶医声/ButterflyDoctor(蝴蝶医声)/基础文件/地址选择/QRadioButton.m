...
#define Q_RADIO_ICON_WH                     (10.0)
#define Q_RADIO_ICON_he (15.0)
...
- (id)initWithDelegate:(id)delegate groupId:(NSString*)groupId {
    ...
    if (self) {
        ...
        [self setImage:[UIImage imageNamed:@"a12ss"] forState:UIControlStateNormal];
        [self setImage:[UIImage imageNamed:@"a12ss"] forState:UIControlStateSelected];
...
{
    return CGRectMake(0, (CGRectGetHeight(contentRect) - Q_RADIO_ICON_he)/2.0, Q_RADIO_ICON_WH, Q_RADIO_ICON_he);
}
