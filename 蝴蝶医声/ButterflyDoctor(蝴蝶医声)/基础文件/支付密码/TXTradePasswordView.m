...
- (id)initWithFrame:(CGRect)frame WithTitle :(NSString *)title
{
    ...
    if (self)
    {
        ...
        UIView * underview = [[UIView alloc]initWithFrame:CGRectMake(SCREEN_WIDTH / 2 - 2 * boxWidth, 60, boxWidth * 4, boxWidth)];
        [underview.layer setBorderWidth:1.0];
        underview.layer.borderColor = [[UIColor grayColor]CGColor];
        underview.backgroundColor = [UIColor whiteColor];
        [self addSubview:underview];
        
        UIView * fgx1 = [[UIView alloc]initWithFrame:CGRectMake(boxWidth, 0, 1, boxWidth)];
        fgx1.backgroundColor = [UIColor grayColor];
        [underview addSubview:fgx1];
        
        UIView * fgx2 = [[UIView alloc]initWithFrame:CGRectMake(boxWidth * 2, 0, 1, boxWidth)];
        fgx2.backgroundColor = [UIColor grayColor];
        [underview addSubview:fgx2];
        
        UIView * fgx3 = [[UIView alloc]initWithFrame:CGRectMake(boxWidth * 3, 0, 1, boxWidth)];
        fgx3.backgroundColor = [UIColor grayColor];
        [underview addSubview:fgx3];
        
        ///  假的输入框
        _view_box = [[UIView alloc]initWithFrame:CGRectMake(SCREEN_WIDTH / 2 - 2 * boxWidth, 60, boxWidth, boxWidth)];
...
//        _view_box.backgroundColor = [UIColor whiteColor];
        ...
        _view_box2 = [[UIView alloc]initWithFrame:CGRectMake(SCREEN_WIDTH / 2 - 1 * boxWidth, _view_box.frame.origin.y, boxWidth, boxWidth)];
...
//        _view_box2.backgroundColor = [UIColor whiteColor];
        ...
        _view_box3 = [[UIView alloc]initWithFrame:CGRectMake(SCREEN_WIDTH / 2 , _view_box.frame.origin.y, boxWidth, boxWidth)];
...
//        _view_box3.backgroundColor = [UIColor whiteColor];
        ...
        _view_box4 = [[UIView alloc]initWithFrame:CGRectMake(SCREEN_WIDTH / 2 + boxWidth, _view_box.frame.origin.y, boxWidth, boxWidth)];
