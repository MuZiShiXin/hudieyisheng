...
//        [back bhb_setImageWithResourcePath:@"images.bundle/tabbar_compose_below_background" AutoSize:NO];
        ...
        btn.frame = CGRectMake(0, 0,70, 60);
        btn.center = CGPointMake(frame.size.width / 2 , frame.size.height / 4);
//        [btn bhb_setImage:@"icon93"];
        [btn setBackgroundImage:[UIImage imageNamed:@"icon27"] forState:UIControlStateNormal];
