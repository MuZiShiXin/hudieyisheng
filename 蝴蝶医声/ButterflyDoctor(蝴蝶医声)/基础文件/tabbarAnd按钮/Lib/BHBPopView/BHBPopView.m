...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [logo bhb_setImageWithResourcePath:@"images.bundle/compose_slogan1" AutoSize:YES];
        ...
        [self addSubview:bar];
        self.bottomBar = bar;
        BHBCenterView * centerView = [[BHBCenterView alloc]initWithFrame:CGRectMake(0, self.frame.size.height - self.frame.size.height * 0.4 - 48 , self.frame.size.width, self.frame.size.height * 0.4)];
...
//    UIColor *tintColor = [UIColor colorWithWhite:0.95 alpha:0.78];
    UIColor * tintColor = [UIColor colorWithRed:105/255 green:105/255 blue:105/255 alpha:0.5];
