...
- (void)showRightWithTitle: (NSString *)title autoCloseTime: (CGFloat)autoCloseTime{
    ...
    info.title = title;
    [[LKBubbleView defaultBubbleView] showWithInfo: info autoCloseTime: 0.5];
}
...
- (void)showInfoWithTitle: (NSString *)title autoCloseTime: (CGFloat)autoCloseTime {
    ...
    [[LKBubbleView defaultBubbleView] showWithInfo: iconInfo autoCloseTime: autoCloseTime];
