...
#define MainRedColor RGB(120,189,255)
...
@property (nonatomic, assign) NSInteger yearNumber;//年份数量
@property (nonatomic, assign) NSInteger startYearNumber;//开始年份
@property (nonatomic, strong) NSString * leftButtonName;//

@property (nonatomic, weak) id<XFDaterViewDelegate> delegate;
...
@property (nonatomic , assign) BOOL YearBool;//是否移动
