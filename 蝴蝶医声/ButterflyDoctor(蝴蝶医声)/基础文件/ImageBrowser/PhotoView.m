...
//        }];
        ...
        BOOL isCached = [manager cachedImageExistsForURL:[NSURL URLWithString:[photoUrl stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]]];
        if (!isCached) {//没有缓存
            hud = [MBProgressHUD showHUDAddedTo:self animated:YES];
            hud.mode = MBProgressHUDModeDeterminate;
        }
        [self.imageView sd_setImageWithURL:[NSURL URLWithString:[photoUrl stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]] placeholderImage:[UIImage imageNamed:@"home_bg_picture"] options:0 progress:^(NSInteger receivedSize, NSInteger expectedSize){
