...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell.moreButtonClickedBlock) {
        ...
        [cell setDidClickCommentLabelBlock:^(SDTimeLineCellCommentItemModel * CommentItemModel, CGRect rectInWindow, NSIndexPath *indexPath) {
            weakSelf.textField.placeholder = [NSString stringWithFormat:@"  回复：%@", CommentItemModel.firstUserName];
            weakSelf.currentEditingIndexthPath = indexPath;
            [weakSelf.textField becomeFirstResponder];
            weakSelf.isReplayingComment = YES;
            weakSelf.commentToUser =  CommentItemModel.firstUserName;
