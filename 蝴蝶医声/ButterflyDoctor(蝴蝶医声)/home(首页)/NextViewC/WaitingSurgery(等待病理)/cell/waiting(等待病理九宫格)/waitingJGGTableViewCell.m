...
@interface waitingJGGTableViewCell ()
...
@end
@implementation waitingJGGTableViewCell

+ (instancetype)cellWithTableView:(UITableView *)tableView
{
    static NSString *ID = @"waitingJGGTableViewCell";
    waitingJGGTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
        // 从xib中加载cell
        cell = [[[NSBundle mainBundle] loadNibNamed:@"waitingJGGTableViewCell" owner:nil options:nil] lastObject];
...
//    self.backgroundColor = [UIColor appAllBackColor];
    ...
    .rightSpaceToView(self.underView,0)
    .topSpaceToView(self.chuyuan,Gato_Height_548_(0))
    .heightIs(Gato_Height_548_(1));
    
    self.closeButton.sd_layout.topSpaceToView(self.chuyuan, Gato_Height_548_(10))
