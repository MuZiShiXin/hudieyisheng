...
- (void)performLayout {
    ...
    if ([self.navigationController.viewControllers objectAtIndex:0] == self) {
        ...
        //点击图片方法 设置 barbuttonItem文字内容
        _doneButton = [[UIBarButtonItem alloc] initWithTitle:NSEaseLocalizedString(@"取消", nil) style:UIBarButtonItemStylePlain target:self action:@selector(doneButtonPressed:)];
        // Set appearance
